                ...
                <div class="col-12">
                    <div id="menu" class="">
                        <div id="onglets" class="size_navigation dessus_menu row justify-content-around" style="width: 50%; margin-left: 25%;"> 
                            <button type="submit" class="col-2" onclick="show_menu('salon')" style="padding: 0%;"> <p class="dessus_nom_pi�ce">Salon</p> <img src="images/item_salon/salon_full.jpg" style="width: 100%;"></button>
                            <button type="submit" class="col-2" onclick="show_menu('cuisine')" style="padding: 0%;" > <p class="dessus_nom_pi�ce">Cuisine</p> <img src="images/item_cuisine/cuisine_full.jpg" style="width: 100%;"> </button>
                            <button type="submit" class="col-2" onclick="show_menu('bureau')"  style="padding: 0%;"> <p class="dessus_nom_pi�ce">Bureau</p> <img src="images/item_bureau/bureau_full.jpg" style="width: 100%;"> </button>
                            <button type="submit" class="col-2" onclick="show_menu('garage')" style="padding: 0%;" > <p class="dessus_nom_pi�ce">Garage</p> <img src="images/item_garage/garage_full.jpg" style="width: 100%;"> </button>
                        ...
                        <div id="salon" class=""><img src="images/item_salon/salon_wall.jpg" style="width: 100%" >
                            <img class="bibiotheque" src="images/item_salon/library-book-cart-vector-graphic.png" onclick="clickItem(3)"/>
                            <img class="elevator" src="images/item_salon/elevator.png" onclick="clickItem(1)"/>
                            <img class="baffle"src="images/item_salon/speaker-35556_1280.png" onclick="clickItem(2)"/>
                            <img class="baffle2"src="images/item_salon/speaker-35556_1280.png" onclick="clickItem(6)"/>
                            <img class="tele"src="images/item_salon/tv_star.png" onclick="clickItem(4)"/>
                        </div>
 ...
 <img class="crevette" src="images/item_cuisine/cartoon-2027717_960_720.png"/> 
   ...
   <img class="fromage" src="images/item_cuisine/swiss-cheese-575540_960_720.png" onclick="clickItem(8)"/>  -->
                        ...
                        <div id="bureau" class="hidden">                     
                            ...
                            <img class="bureau" src="images/item_bureau/desk.png" onclick="clickItem(31)"/>
                            <img class="elevator2" src="images/item_bureau/elevator.png" onclick="clickItem(32)"/>
                            <img class="coffre" src="images/item_bureau/cofre.png" onclick="clickItem(31)"/>
                            <img class="joconde" src="images/item_bureau/joconde.png" onclick="clickItem(33)"/>


                            <img class="cle"src="images/item_bureau/key.png" onclick="clickItem(34)"/>
                            <img class="telephone" src="images/item_bureau/phone.png" onclick="clickItem(35)"/>
                            <img class="torche" src="images/item_bureau/torche.png" onclick="clickItem(36)"/>
                            <img class="tortue" src="images/item_bureau/turtle.png" onclick="clickItem(37)"/>                                                    
                        </div>
